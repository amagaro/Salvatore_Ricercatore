...
```mermaid
graph TD
    A["Modello Integrato Cognitivo-Sensoriale"] --> B["1. Sicurezza Olistica (Safety & Security)"]
    A --> C["2. Navigazione e Controllo (Navigation & Control)"]
    A --> D["3. Stimolazione Rigenerativa (Sensory Stimulation & Serenity)"]
    A --> E["4. Ecosistema Relazionale (Social Support & Interaction)"]
    A --> F["5. Appartenenza e Distrazione (Belonging & Distraction)"]

    style A fill:#e6f3ff,stroke:#333,stroke-width:2px
    style B fill:#fff2cc,stroke:#d1ae73,stroke-width:1px
